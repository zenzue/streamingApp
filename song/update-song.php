<?php
    ...
    use Aws\S3\Exception\S3Exception;
        ...
        $album_id = addslashes($_POST['album']);
        ...
        $vid = substr($pub_song_id,2);
        $pub_song_id = $prefix . $vid;;

        $song = $_FILES['song']['name'];
        $valid_extensions = array('mp3', 'm4a'); // valid extensions

        if ($song == "") {
            $sql = "UPDATE songs SET pub_song_id = '".$pub_song_id."', album_id = '".$album_id."', song_name = '".$song_name."', song_rating = '".$song_rating."', song_favourite = '".$song_rating."', genere_id = '".$genere."', lyric = '".$lyric."', year = '".$year."', publisher_id = '".$publisher."', song_role = '".$song_type."' WHERE song_id = " . $song_id;
            ...
            try {
                ...
                if(in_array($ext, $valid_extensions)) { 
                    ...
                    if ($result) {
                        ...
                        $sql = "UPDATE songs SET pub_song_id = '".$pub_song_id."', album_id = '".$album_id."', song_name = '".$song_name."', song_rating = '".$song_rating."', song_favourite = '".$song_rating."', genere_id = '".$genere."', song_high_path = '".$song_high."', song_low_path = '".$song_low."', lyric = '".$lyric."', year = '".$year."', publisher_id = '".$publisher."', song_role = '".$song_type."' WHERE song_id = " . $song_id;
