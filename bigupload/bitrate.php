<?php
	...
	// exec('ffmpeg -i tmp/takingchance.mp3 -acodec libmp3lame -b:a 8k -ac 1 -ar 11025 tmp/outputfile.mp3');

		// exec('ffmpeg -i "/home/thura/Desktop/songs/myanmarsong/ဂ်ီလတ္ - အရာရာျခားနားလည္း.mp3" -acodec libmp3lame -b:a 64k -ac 1 -ar 11025 upload/6fbee52778cf2ddb37db3cc9d5603f1e.mp3');
